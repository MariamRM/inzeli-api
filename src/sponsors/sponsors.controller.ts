import { Controller, Get, Param, Post, UseGuards, Req, Body, Query } from '@nestjs/common';
...
export class SponsorsController {
  ...
  async list() {
    ...
    } catch (e: any) { return err(e?.message || 'Failed'); }
  }
  ...
  async detail(@Param('code') code: string) {
    ...
    } catch (e: any) { return err(e?.message || 'Failed', e?.message); }
  }
